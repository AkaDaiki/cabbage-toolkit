...
# -*- coding: utf-8 -*-
"""
Bottle (patched for Python 3.12+)
This patched version ensures compatibility when the built-in cgi module is removed.
"""
...
# In Python 3.12, the cgi module has been removed. Bottle uses cgi.escape and
# cgi.FieldStorage internally. We define a minimal compatibility layer here.
...
# Construct a fake cgi module if not present
try:
    import cgi
    ...
    # --- replacement for cgi.escape ---
    fake_cgi.escape = html_escape

    # --- dummy FieldStorage class to prevent crashes ---
    class FieldStorage:
        def __init__(self, **kwargs):
            self.list = []
        def __iter__(self): return iter([])
        def __bool__(self): return False
        def __repr__(self): return "<Fake FieldStorage empty>"
...
###############################################################################
# --- Original Bottle code resumes below ---
###############################################################################
